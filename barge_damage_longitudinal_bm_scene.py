...
class BargeDamageLongitudinalBMScene(BargeSceneBase):
    ...
    def construct(self):
        ...
        plan_cl_label = Text("℄", font_size=14).next_to(plan_cl.get_right(), RIGHT, buff=0.05)
        ...
        txt1 = cx(Text("Langskips flotasjonssenter før skade", font_size=20).move_to([eq_cx, eq_top, 0]))
