# Notes — BargeDamageKBScene

## Scene metadata
- Scene: `BargeDamageKBScene`
- Source: `barge_damage_kb_scene.py`
...
## Phase 2 — Show `KB` and buoyancy center before damage
...
## Phase 3 — Introduce damaged transverse section
...
## Phase 4 — Show `KB_S` and buoyancy center after damage
...
## Phase 5 — Compare the intact and damaged `KB` relations
- Goal: State the rectangular-section rule and compare the two conditions directly.
- Visual cue:
  - Write `For rektangulær lekter` below the sections.
