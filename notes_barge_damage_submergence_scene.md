# Notes — BargeDamageSubmergenceScene

## Scene metadata
- Scene: `BargeDamageSubmergenceScene`
- Source: `barge_damage_submergence_scene.py`
...
## Phase 2 — Reveal damaged profile and reference labels
...
## Phase 3 — Indicate damage location
...
## Phase 4 — Flooding and sinking with live `T_S`
...
## Phase 6 — Write equilibrium after damage
...
## Phase 7 — Use unchanged displacement volume
...
- Common pitfall: Interpreting “unchanged” as unchanged draft rather than unchanged displacement volume.
- Takeaway: The governing equilibrium condition is equality of displacement volume.

---

## Phase 8 — Solve for new equilibrium draft
