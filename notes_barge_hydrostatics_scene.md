# Notes — BargeHydrostaticsScene

## Scene metadata
- Scene: `BargeHydrostaticsScene`
- Source: `barge_hydrostatics_scene.py`
...
## Phase 2 — Reveal profile/transverse views and references
...
## Phase 3 — Add waterlines and `WL` labels
...
## Phase 6 — Present displacement relation
...
<ul>
  ...
  <li>Rectangular displacement model: ∇ = L · B · T.</li>
</ul>
```
