...
class BargeDamageBMScene(BargeSceneBase):
    ...
    def construct(self):
        ...
        txt1 = cx(Text("Vannlinjeareal fÃ¸r skade", font_size=20).move_to([eq_cx, eq_top, 0]))
        ...
        intro_text = Text("Reduksjon av tverrskips BM ved tap av vannlinjeareal", font_size=36).move_to(ORIGIN)
