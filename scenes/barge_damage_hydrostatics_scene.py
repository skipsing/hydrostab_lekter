...
from scenes.barge_geometry import ShipParameters, scaled, create_section_rect, create_dimension_arrow
...
class BargeDamageHydrostaticsScene(Scene):
    ...
    def phase_4_explain_kb_cause(self):
        ...
        callout = Text(
            ...
            "n̴r geometri og neddykket volum fordeles annerledes.",
            font_size=24,
            color=BLACK,
