...
class BargeDamageKBScene(BargeSceneBase):
    ...
    def construct(self):
        ...
        # â”€â”€ helper: waterline dash line â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        def make_wl(x_left, x_right, y, col=BLUE):
            l = Line([x_left - 0.2, y, 0], [x_right + 0.2, y, 0], color=col, stroke_width=2)
            l.set_dash([0.1, 0.1])
            return l

        # â”€â”€ left section: before damage â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        sect_l = Rectangle(
            width=sw, height=sh,
        ...
        sect_l_title = MathTex(r"\text{FÃ¸r skade}", font_size=28).next_to(sect_l, UP, buff=0.3)
        sect_l_sublabel = MathTex(r"\text{Tverrsnitt}", font_size=24).next_to(sect_l, DOWN, buff=0.55)

        # â”€â”€ right section: after damage â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        sect_r = Rectangle(
            width=sw, height=sh,
            stroke_color=GREEN, stroke_width=3, fill_opacity=0,
        ...
        # â”€â”€ equation at bottom â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        eq_text = Text("For rektangulÃ¦r lekter", font_size=24).move_to([0, -2.0, 0])
        eq = MathTex(
            r"K\!B = \frac{T}{2} < K\!B_S = \frac{T_S}{2}",
            font_size=34,
        ).move_to([0, -2.5, 0])

        # â”€â”€ animation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        self.add(intro_text)
        self.wait(0.8)
