# Notes â€” BargeGeometryScene

## Scene metadata
- Scene: `BargeGeometryScene`
- Source: `scenes/barge_geometry_scene.py`
...
## Phase 2 â€” Reveal views and reference labels
...
- Visual cue:
  ...
  - Show centerline markers (`â„„`) and AP/FP labels.
...
## Phase 4 â€” Introduce `B` in plan view
