...
if __name__ == "__main__":
    print("Run with:")
    print("  manim -ql test.py BargeGeometryScene")
    print("  manim -ql test.py BargeHydrostaticsScene")
    print("  manim -ql test.py BargeCompartmentsScene")
    print("  manim -ql test.py BargeDamageSubmergenceScene")
    print("  manim -ql test.py BargeDamageKBScene")
    print("  manim -ql test.py BargeDamageBMScene")
    print("  manim -ql test.py BargeDamageHydrostaticsScene")
    print("  manim -ql test.py BargeDamageTrimScene")
